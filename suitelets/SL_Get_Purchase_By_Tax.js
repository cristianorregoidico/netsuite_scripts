 ...
 * @Description Suitelet para obtener compras agrupadas por código de impuesto
 */
      ...
      try {
        ...
        searchResults.forEach(function (result) {
          ...
          if (values['GROUP(mainname)']) {
            ...
            if (Array.isArray(cm) && cm[0]) vendor = cm[0].text || cm[0].value || null;
            else vendor = cm.text || cm.value || cm || null;
          }
