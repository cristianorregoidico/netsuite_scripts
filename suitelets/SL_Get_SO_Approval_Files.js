 ...
 * @Description Suitelet para obtener archivos adjuntos de aprobación de Sales Order
 */
        ...
        if (context.request.method === 'GET') {
            ...
            try {
                ...
                var savedSearch = search.load({
                    id: 'customsearch_so_approval_files' 
                });
                ...
                searchResults.forEach(function(result) {
                    results.push({
                      ...
                      file_id: result.getValue({ name: 'internalid', join: 'file' }),
                    });
                });
